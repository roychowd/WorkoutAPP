    ...
    return(
      <div className='topdiv'>
          ...
          <main className="pa4 80 FormFontColor">
            <form className="measure center">
              <fieldset id="sign_up" class="ba b--transparent ph0 mh0">
                ...
                <div className="mt3">
                  <label className="db fw8 lh-copy f6 fonts" for="email-address">Email</label>
                ...
                <div className="mv3">
                  <label className="db fw8 lh-copy f6 fonts" for="password">Password</label>
                ...
                <label className="pa0 ma0 lh-copy f6 fw8 pointer"><input type="checkbox"/> Remember me </label>
              </fieldset>
              <div className="">
        ...
        <div className='col2'>
          ...
          <h3 className='peptalk' style={{color:'white'}}>Your Fitness Goals</h3>
          <h5 className='peptalk'>We wish to bring the message of a healthy lifestyle to the students of the University of Alberta, and provide them with the neccessary tools to do so!
          </h5>
          {/* <div id='homepageCircle' className='"row'>
            <div className='coolCircle col-sm-6'>30</div>
            <div className='coolCircle col-sm-6'>30</div>
          </div> */}
          <circle className='circle'><img className='icon' src={Dumbell}/></circle>
          <circle className='circle'><img className='icon' src={Runner}/></circle>
          <circle className='circle'><img className='icon' src={Burger}/></circle>

        </div>
        {/* //==============Third SECTION==========// */}
        <div className='col3'>
          <h5 className='bottomhead'>Created by <a href='https://github.com/AnkushSharma2698'>Ankush Sharma</a> and <a href='https://github.com/roychowd'>Dhruba Chowdhury</a> </h5>
          <a className='cover' href='https://github.com/roychowd/WorkoutAPP'><img className='gitLogo pointer' src={GitLogo}/></a>
        </div>
      </div>
    )
  }
