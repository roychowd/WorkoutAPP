  ...
  return(
    <div className='container'>
      ...
      <div class="form-group">
        ...
        <input type="" class="form-control btn-outline-primary" placeholder=""/>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="container">
              ...
              <li className='activityItem'>
                ...
                <small class=" float-right form-text text-muted Information">Physically active only 1-2 times a week.<br/></small>
                <div class="check"></div>
              </li>
              ...
              <li className='activityItem'>
                ...
                <small class=" float-right form-text text-muted Information">Physically active 3-4 times a week.<br/></small>
              ...
              <li className='activityItem'>
                ...
                <small class=" float-right form-text text-muted Information">Physically active 5-6 times a week.<br/></small>
                <div class="check"><div class="inside"></div></div>
              </li>
            </ul>
            </div>
          ...
          <div class="row hain">
              <a href='/Dashboard' class="btn btn-primary btn-block bigbutton" >Submit </a>
          </div>
        </div>
  );
}
